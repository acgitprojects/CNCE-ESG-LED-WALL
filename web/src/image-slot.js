...
class ImageSlot extends HTMLElement {
  ...
  _applyView() {
    ...
    const l = (50 + this._view.x) + '%', tt = (50 + this._view.y) + '%';
    this._img.style.width = w; this._img.style.height = h;
    this._img.style.left = l; this._img.style.top = tt;
    this._img.style.objectFit = '';
    this._spill.style.width = w; this._spill.style.height = h;
    this._spill.style.left = l; this._spill.style.top = tt;
  }
  ...
  _render() {
    ...
    if (url) {
      ...
      this._ghost.removeAttribute('src'); this._empty.style.display = 'flex';
